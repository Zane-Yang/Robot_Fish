...
echo_and_run cd "/home/zane/robot_fish/src/uuv_simulator/uuv_control/uuv_trajectory_control"
...
echo_and_run /usr/bin/env \
    ...
    "/home/zane/robot_fish/src/uuv_simulator/uuv_control/uuv_trajectory_control/setup.py" \
     \
    build --build-base "/home/zane/robot_fish/build/uuv_simulator/uuv_control/uuv_trajectory_control" \
    install \
    --root="${DESTDIR-/}" \
