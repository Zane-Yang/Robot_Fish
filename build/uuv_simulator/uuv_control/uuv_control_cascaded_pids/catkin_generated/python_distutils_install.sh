...
echo_and_run cd "/home/zane/robot_fish/src/uuv_simulator/uuv_control/uuv_control_cascaded_pids"
...
echo_and_run /usr/bin/env \
    ...
    "/home/zane/robot_fish/src/uuv_simulator/uuv_control/uuv_control_cascaded_pids/setup.py" \
     \
    build --build-base "/home/zane/robot_fish/build/uuv_simulator/uuv_control/uuv_control_cascaded_pids" \
    install \
    --root="${DESTDIR-/}" \
