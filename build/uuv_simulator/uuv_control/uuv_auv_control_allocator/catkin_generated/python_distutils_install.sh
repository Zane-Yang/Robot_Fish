...
echo_and_run cd "/home/zane/robot_fish/src/uuv_simulator/uuv_control/uuv_auv_control_allocator"
...
echo_and_run /usr/bin/env \
    ...
    "/home/zane/robot_fish/src/uuv_simulator/uuv_control/uuv_auv_control_allocator/setup.py" \
     \
    build --build-base "/home/zane/robot_fish/build/uuv_simulator/uuv_control/uuv_auv_control_allocator" \
    install \
    --root="${DESTDIR-/}" \
